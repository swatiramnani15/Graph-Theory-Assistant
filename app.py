...
topics = [
    ...
    "Graph Coloring", "Bipartite Graphs", "Topological Sort",
    "Strongly Connected Components", "Network Flow", "Adjacency Matrices",
    "Trees & Forests", "Chromatic Number", "Graph Isomorphism",
    "Shortest Paths", "Cycle Detection", "Directed Graphs",
    "Weighted Graphs", "Centrality Measures", "Spectral Graph Theory",
]
...
<div class="site-wrapper">
  ...
  <section class="hero">
    ...
    <h1 class="hero-title">
      Graph<br><em>Theory</em><br>Assistant
    </h1>
    <p class="hero-sub">
      An intelligent conversational guide through the elegant world of graphs,
      nodes, edges, and the algorithms that connect them.
    </p>
    <div class="hero-divider"></div>
    <div class="cta-wrap">
      <a class="cta-btn" href="{CHATBOT_URL}" target="_blank">
        Open the Assistant <span class="cta-arrow">→</span>
      </a>
    </div>
  </section>
    ...
    <div class="about-grid">
      <div>
        <h2 class="about-heading">
          Your personal tutor for <strong>graph mathematics</strong>
        </h2>
        <p class="about-text">
          Graph Theory Assistant is a purpose-built AI chatbot designed to make
          one of computer science's most beautiful disciplines approachable and
          engaging — whether you're a student, researcher, or curious mind.
        </p>
        <p class="about-text">
          Ask anything: from the basics of vertices and edges to the intricacies
          of NP-hard problems. The assistant reasons through problems step-by-step,
          explains proofs in plain language, and helps you build genuine intuition.
        </p>
      </div>
      <div class="features-grid">
        ...
        <div class="feat-card">
          ...
          <p class="feat-desc">Bring your homework or research questions. The assistant thinks alongside you.</p>
        </div>
        <div class="feat-card">
          <span class="feat-icon">📐</span>
          <p class="feat-title">Proof Assistance</p>
          <p class="feat-desc">Understand and construct rigorous proofs with guided reasoning and hints.</p>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="topics-section">
    <p class="section-label">Topics Covered</p>
